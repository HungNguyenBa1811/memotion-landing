...
export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-surface-secondary pt-11">
      <div className="w-full max-w-apple mx-auto px-6 lg:px-8 pt-section pb-16 text-center">
        ...
        >
          Giải pháp phục hồi chức năng chuẩn y khoa tại nhà.
          Xóa bỏ nỗi lo của "Thế hệ Sandwich" bằng công nghệ nhận diện 3D
      ...
      >
        <div className="relative aspect-[16/9] md:aspect-[2/1] rounded-apple-xl overflow-hidden bg-surface-tertiary shadow-2xl">
          <div className="absolute inset-0 flex items-center justify-center text-text-tertiary text-body">
            [Product Screenshot: App dashboard showing rehabilitation progress]
          </div>
        </div>
      </motion.div>
    </section>
